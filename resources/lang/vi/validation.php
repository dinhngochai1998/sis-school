...
return [
    ...
    'already_have_primary_teacher'         => 'lớp này đã có giáo viên chủ nghiệm',
    'you_have_the_same_user'               => 'bạn đã chọn trùng user',
    'confirmation_delete_class'            => 'lớp đã chọn còn :number học sinh, bạn phải xóa học sinh (sinh viên) khỏi lớp để xóa lớp',
    'confirmation_delete_subject'          => 'Môn học đang có lớp đang học. Bạn không thể xóa.',
    'confirmation_delete_term'             => 'kì học đã chọn chứa :number lớp (các lớp), bạn phải xóa lớp (các lớp) khỏi hệ thống để xóa kì học',
    'invalid'                              => 'Dữ liệu không hợp lệ',
    'you_have_the_same_value'              => 'Dữ liệu của bạn đã bị trùng! vui lòng xem lại',
    'must_have_at_least_1_primary_teacher' => 'Phải có ít nhất 1 giáo viên chủ nghiệm trong lớp',
    'confirmation_delete_grade_scale'      => "Vẫn còn :number môn trong thang điểm . Bạn không thể xóa",
    "not-exist"                            => ":attribute không tồn tại",
    'class-not-in-lms-system'              => ':attribute không phải lớp thuộc hệ thống sis',
    "duplicate"                            => "Trường :attribute trùng lặp",
    'survey'                               => 'survey không tồn tại',
];
